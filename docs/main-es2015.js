...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 8, vars: 0, consts: [["type", "button", "aria-label", "Menu", "aria-controls", "navigation", 1, "hamburger"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
SidebarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SidebarComponent, selectors: [["app-sidebar"]], decls: 10, vars: 0, consts: [["routerLink", "/posts", "routerLinkActive", "--active"], ["routerLink", "/menu", "routerLinkActive", "--active"], ["routerLink", "/text", "routerLinkActive", "--active"]], template: function SidebarComponent_Template(rf, ctx) { if (rf & 1) {
