...
DropdownComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DropdownComponent, selectors: [["app-dropdown"]], hostVars: 3, hostBindings: function DropdownComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassProp"]("--loading", ctx._loading);
                ...
                multi: true
            }])], decls: 8, vars: 11, consts: [["type", "button", "attr.aria-haspopup", "true", 1, "btn", 3, "disabled", "click"], ["ref", ""], [4, "ngIf"], [3, "parent", "position", 4, "ngIf"], [1, "spinner"], [3, "parent", "position"], ["role", "menu", "aria-labelledby", "menubutton", 3, "id"], ["role", "none", 4, "ngFor", "ngForOf"], ["role", "none"], ["type", "button", "role", "menuitem", 3, "appAutofocus", "click"]], template: function DropdownComponent_Template(rf, ctx) { if (rf & 1) {
